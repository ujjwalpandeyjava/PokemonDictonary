package poke.be.poke_be.services;
...
public class UpdateJSONData {
	...
	private void checkConfigProps() throws IOException {
		...
		// APIsGettingEndpoints.type_effectiveness);
		// System.out.println("ENUMS name attached: -" +
		// APIsGettingEndpoints.type_effectiveness.name());
		// System.out.println("ENUMS value attached: -" +
		// APIsGettingEndpoints.type_effectiveness.getAction());
	}
}